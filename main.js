...
var roleRepairman = require('role.farmer');
...
module.exports.loop = function () {
    ...
    if(harvesters.length < 3) {
        ...
        Game.spawns['boss'].spawnCreep([CARRY,CARRY,CARRY,CARRY,CARRY,CARRY,MOVE,MOVE], newName, 
    ...
    Game.spawns['boss'].spawnCreep([WORK,WORK,WORK,CARRY,CARRY,CARRY,CARRY,MOVE,MOVE,MOVE,MOVE], newName, 
        {memory: {role: 'builder'}});
    }else if(upgraders.length < 4) {
        var newName = 'Upgrader-' + Game.time;
        console.log('Spawning new upgrader: ' + newName);
        Game.spawns['boss'].spawnCreep([WORK,WORK,WORK,WORK,WORK,CARRY,CARRY,CARRY,MOVE,MOVE], newName, 
            {memory: {role: 'upgrader'}});
    }else if(repairman.length < 1) {
        var newName = 'Repairman-' + Game.time;
        console.log('Spawning new repairman: ' + newName);
        Game.spawns['boss'].spawnCreep([WORK,WORK,CARRY,CARRY,MOVE,MOVE], newName, 
